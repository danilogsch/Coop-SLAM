...
from .synth_config import bound_size_y, bound_size_x, BEV_WIDTH, BEV_HEIGHT, colors, boundary
from .synth_bev_utils import drawRotatedBox
    ...
    for cls_id in range(num_classes):
        if len(detections[cls_id]) > 0:
            for det in detections[cls_id]:
                ...
                dets.append([cls_id, x, y, z, _h, w, l, _yaw])
